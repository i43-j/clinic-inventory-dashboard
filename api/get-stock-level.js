const N8N_GET_STOCK_LEVELS_WEBHOOK = 'https://i43-j.app.n8n.cloud/webhook/get-stock-levels';
...
export default async function handler(req, res) {
  ...
  try {
    console.log('=== GET STOCK LEVELS PROXY DEBUG ===');
    console.log('Request body:', req.body);
    console.log('Authorization header:', req.headers.authorization);
    console.log('N8N webhook URL:', N8N_GET_STOCK_LEVELS_WEBHOOK);

    // 4) Proxy the request to n8n
    const n8nRes = await fetch(N8N_GET_STOCK_LEVELS_WEBHOOK, {
      method: 'POST',
      headers: {
    ...
    console.error('[api/get-stock-levels] proxy error:', err);
