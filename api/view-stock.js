const N8N_VIEW_STOCK_WEBHOOK = 'https://i43-j.app.n8n.cloud/webhook/view-stock';
...
export default async function handler(req, res) {
  ...
  try {
    console.log('=== VIEW STOCK PROXY DEBUG ===');
    console.log('Request body:', req.body);
    console.log('Authorization header:', req.headers.authorization);
    console.log('N8N webhook URL:', N8N_VIEW_STOCK_WEBHOOK);

    // 4) Proxy the request to n8n
    const n8nRes = await fetch(N8N_VIEW_STOCK_WEBHOOK, {
      method: 'POST',
      headers: {
    ...
    console.error('[api/view-stock] proxy error:', err);
